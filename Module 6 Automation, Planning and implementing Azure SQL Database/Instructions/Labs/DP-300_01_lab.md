---
lab:
    title: 'Lab 1 - Creating SQL Server VM using Portal'
    module: 'SQL on Azure'
---


# Lab 1 - Creating SQL Server VM using Portal
...
1. Create a SQL Server on an Azure Virtual Machine using the Azure Portal.
